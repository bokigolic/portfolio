export const projects = [
...

  {
    ...
    description: "I created this project to challenge myself and learn advanced concepts in React. Social media apps use the latest ReactJS technology. The app mimics the core features of Facebook, allowing users to create and manage posts, upload images, write comments, and respond to posts with likes and reactions. I also plan to expand the feature set to include chat features and video sharing.",
    image: '/images/1.png',
  ...
  {
    title: 'Anna Olson Website',
    description: "To build a responsive website, you'll need to use HTML, CSS, and possibly JavaScript and frameworks like Bootstrap. Responsive design techniques like flexbox can also help ensure your website looks good on all devices. Using a grid system and a carousel can also help with layout and display of content.",
    image: '/images/2.png',
    tags: ['HTML', 'Css', 'Bootstrap'],
    visit: 'https://github.com/bokigolic/AnnaOlsonWebsite',
    source: 'https://bokigolic.github.io/AnnaOlsonWebsite/',
    id: 1,
  },
